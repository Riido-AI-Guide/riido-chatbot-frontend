    ...
    <div className="bg-background-canvas flex h-screen">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <footer className="relative shrink-0 px-4 pt-2 pb-2.5">
          {/* Figma footer background — 162px 페이드 + Layer blur 12 / Background blur 1.
              아래로 10px 더 내려 blur 때문에 바닥이 비치지 않게 한다 */}
          <div
            className="canvas-fade-up pointer-events-none absolute inset-x-0 bottom-[-10px] h-[162px] blur-[6px] backdrop-blur-[0.5px]"
            aria-hidden
          />
