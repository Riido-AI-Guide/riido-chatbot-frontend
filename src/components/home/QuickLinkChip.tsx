...
export function QuickLinkChip({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="bg-background-surface border-border-strong hover:bg-fill-hover active:bg-fill-press focus-visible:ring-ring/50 shadow-s flex h-12 items-center gap-2 rounded-full border px-5 py-3 transition-colors outline-none focus-visible:ring-3 disabled:cursor-not-allowed disabled:opacity-50"
    >
